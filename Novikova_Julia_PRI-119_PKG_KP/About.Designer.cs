...
namespace Novikova_Julia_PRI_119_PKG_KP
{
    partial class About
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Данная программа является курсовым проектом студентки группы ПРИ-119 Новиковой Ю." +
    "А.";
            // 
            // label2
            // 
            ...
            this.label2.Text = "Темой курсового проекта является \"Аэропорт\".";
            // 
            // label3
            // 
            ...
            this.label3.Text = "По вопросам качества обращаться к непосредственному исполнителю.";
            // 
            // label4
            // 
            ...
            this.label4.Text = "© 2023 Все права защищены (или не очень)";
            // 
            // button1
            // 
            this.button1.BackColor = System.Drawing.SystemColors.ActiveCaption;
            this.button1.Location = new System.Drawing.Point(657, 237);
